  ...
  render() {
    return (
      <div className="slds-grid slds-grid_vertical component-container">
        <Card
          heading={
            (this.state.fileCount > 1 && <strong>Files {`(${this.state.fileCount})`}</strong>) ||
            (this.state.fileCount === 1 && <strong>File {`(${this.state.fileCount})`}</strong>)
          }
          ...
          <div className="data-table">
            <DataTable
              ...
              fixedHeader
              fixedLayout
              className="slds-p-left_small slds-p-right_small">
              ...
              <DataTableRowActions
                ...
                dropdown={
                  <Dropdown
                    ...
                    iconName="down"
                    options={[{ label: 'Download' }, { label: 'Preview' }, { label: 'Delete' }]}
                  />
                }
              />
            </DataTable>
          ...
          <Modal
            heading="Delete File?"
            isOpen={this.state.showDeletePrompt}
            ariaHideApp={false}
            disableClose
            footer={[
            ...
            <p className="slds-m-around_medium">
